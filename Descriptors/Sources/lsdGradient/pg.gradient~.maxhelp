...
,
					"patching_rect" : [ 75.0, 124.0, 345.0, 122.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 414.0, 446.5, 98.0, 33.0 ],
					"text" : "Select  slope or decrease :"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 414.0, 446.5, 68.0, 20.0 ],
					"text" : "loadmess 0"
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 11.595187,
					"id" : "obj-18",
					"items" : [ "Slope", ",", "Decrease" ],
					"maxclass" : "umenu",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 414.0, 479.5, 98.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 414.0, 506.5, 67.0, 18.0 ],
					"text" : "gradient $1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 414.0, 526.5, 61.0, 20.0 ],
					"text" : "s gradient"
				}
...
,
										...
										"boxes" : [ 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "float" ],
													"patching_rect" : [ 31.0, 46.0, 46.0, 20.0 ],
													"text" : "* -300."
												}
...
, 											{
												"box" : 												{
													...
													"text" : "recordsprite, pensize 2 2, frgb 255 0 0, linesegment $1 $2 $3 $4, closesprite line, drawsprite line 0 0"
												}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 67.0, 434.5, 263.0, 100.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 45.0, 409.5, 323.0, 150.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 552.75, 171.0, 45.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 511.125, 131.5, 150.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 497.75, 124.0, 177.25, 122.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 555.0, 328.0, 68.0, 20.0 ],
					"text" : "loadmess 0"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 555.0, 328.0, 117.0, 33.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 555.0, 358.0, 98.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 555.0, 388.0, 75.0, 18.0 ],
					"text" : "amplitude $1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 555.0, 406.0, 61.0, 20.0 ],
					"text" : "s gradient"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 414.0, 328.0, 86.0, 20.0 ],
					"text" : "loadmess set 1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 414.0, 328.0, 135.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 414.0, 358.0, 98.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 414.0, 388.0, 63.0, 18.0 ],
					"text" : "window $1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 414.0, 298.0, 148.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 414.0, 283.0, 135.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 414.0, 268.0, 135.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 414.0, 406.0, 61.0, 20.0 ],
					"text" : "s gradient"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 390.0, 255.0, 285.0, 304.5 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 92.0, 314.5, 102.0, 20.0 ],
					"text" : "Slope / Decrease",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 15.0, 207.5, 59.0, 20.0 ],
					"text" : "r gradient"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 75.0, 342.5, 89.0, 20.0 ],
					"sig" : 0.0
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Estimation of the slope or the decrease of the spectrum.",
					"textcolor" : [ 0.93, 0.93, 0.97, 1.0 ],
...
, 			{
		...
		"lines" : [ 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 144.5, 398.0, 76.5, 398.0 ],
					"source" : [ "obj-109", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 84.5, 246.0, 60.0, 246.0, 60.0, 420.0, 76.5, 420.0 ],
					"source" : [ "obj-74", 0 ]
				}
