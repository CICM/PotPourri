...
#define	Cicm_free_packed(pointeur) free(pointeur->imagp); free(pointeur->realp);
...
#define Cicm_signal_mul(source1, source2, dest, length) vDSP_vmul(source1, 1, source2, 1, dest, 1, length)
#define Cicm_signal_add(source1, source2, dest, length) vDSP_vadd(source1, 1, source2, 1, dest, 1, length)
#define Cicm_signal_sub(source1, source2, dest, length) vDSP_vsub(source1, 1, source2, 1, dest, 1, length)
...
#define Cicm_fft_magnitude(complex, magnitude, length) vDSP_zvabs(complex, 1, magnitude, 1, length)
#define Cicm_fft_phase(complex, phase, length) vDSP_zvabs(complex, 1, phase, 1, (vDSP_Length)lenght)
#define Cicm_fft_power(magnitude, length) vDSP_vsq(magnitude, 1, magnitude, 1, length)
#define Cicm_fft_decibel(magnitude, decibel, length) vDSP_vdbcon(magnitude, 1, decibel, magnitude, 1, length, 1)

#define Cicm_min(vector, lenght, minimum) vDSP_minv(vector, 1, minimum, lenght)
#define Cicm_max(vector, lenght, maximum) vDSP_maxv(vector, 1, maximum, lenght)
#define Cicm_sum(vector, lenght, sum) vDSP_sve(vector, 1, sum, lenght)
#define Cicm_mean(vector, lenght, mean) vDSP_meanv(vector, 1, mean, lenght)
