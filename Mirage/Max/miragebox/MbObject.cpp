...
MbObject::MbObject(t_object* _mbPointer, t_object* _objectPointer)
{
    m_mbPointer = _mbPointer;
    m_objectPointer = _objectPointer;
    m_scriptingname = gensym("");
    ...
    //m_scriptingname = jbox_get_varname(jb); // scripting name
    if (m_scriptingname && m_scriptingname != gensym(""))
    {
